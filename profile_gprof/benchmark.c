...
// LC nodes 3.3 GHz * 4-element (256-bit) vector * 2 vector pipelines * 1 ops in an FMA = 26.4 GFlops/s
#define MAX_SPEED 26.4  // defining Roar LC node Max Gflops/s per core with peak TurboBoost Frequency
